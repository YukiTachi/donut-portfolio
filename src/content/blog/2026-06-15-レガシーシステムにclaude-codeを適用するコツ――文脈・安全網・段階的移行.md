...
description: 長く動き続けるレガシーシステムにAIコーディングエージェント「Claude
  Code」を適用するための実践的なコツを、公式ドキュメントと公的統計に基づいて整理します。レガシーの本質はテストがなく変更の影響が読めないこと。CLAUDE.mdへの暗黙知の明文化、特性化テストによる安全網、探索と実装の分離・段階的移行という三つの軸で、AIの速さを安全に活かす順序を解説します。
